...
## add video rule
sleep 1
urlkpdat="https://cdn.jsdelivr.net/gh/ilxp/koolproxy@main/rules/kp.dat"
curl -sL -m 30 --retry 2 "$urlkpdat" -o package/diy/luci-app-ikoolproxy/root/usr/share/koolproxy/data/rules/kp.dat >/dev/null 2>&1
