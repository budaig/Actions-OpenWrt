...
download_files() {
    ...
    curl -sL -m 30 --retry 2 https://cdn.jsdelivr.net/gh/Loyalsoldier/v2ray-rules-dat@release/gfw.txt -o /etc/smartdns/sitegfw.txt
    curl -sL -m 30 --retry 2 https://cdn.jsdelivr.net/gh/Loyalsoldier/v2ray-rules-dat@release/china-list.txt -o /etc/smartdns/sitechn.txt
    ...
    ##github hosts
    curl -sL -m 30 --retry 2 https://cdn.jsdelivr.net/gh/hululu1068/AdRules@main/rules/github-hosts.conf -o /etc/smartdns/gthosts.conf
